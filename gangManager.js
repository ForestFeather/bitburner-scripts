...
const SORT_TYPES = {
	...
	STR_ASC_MULT: 'Strength Ascension Multiplier',
}
const DIRECTIONS = {
	ASC: 'Ascending',
	DESC: 'Descending',
...
export async function main(ns) {
	...
	let nextAscensionAttempt = new Date().getTime() + 60

	while (true) {
		const doAscension = getItem(settings.keys.doAscension) || true
		const buyEquipment = getItem(settings.keys.buyEquipment) || true
