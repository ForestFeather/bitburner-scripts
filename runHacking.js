...
export async function main(ns) {
  ...
  if (homeRam >= 32) {
    ...
    await ns.run('spider.js', 1, 'purchaseServers.js')
	...
	if(homeRam >= 256) {
		if (player.inteligence > 0) { 
			...
			ns.tprint(`[${localeHHMMSS()}] Spawning buyPrograms.js`)
			await ns.run('spider.js', 1, 'buyPrograms.js')
		}
	}
    ...
    ns.tprint(`[${localeHHMMSS()}] Spawning spider.js to mainHack.js`)
